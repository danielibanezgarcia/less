...
class parse_tree(TreeOfNode):
    ...
    @staticmethod
    def PrintTree(n: "TreeConstPreorderIteratorNode", k: "int", depth: "int") -> "void":
        return _pyfreeling.parse_tree_PrintTree(n, k, depth)
...
def parse_tree_PrintTree(n: "TreeConstPreorderIteratorNode", k: "int", depth: "int") -> "void":
    return _pyfreeling.parse_tree_PrintTree(n, k, depth)
...
class dep_tree(TreeOfDepnode):
    ...
    @staticmethod
    def PrintDepTree(n: "TreeConstPreorderIteratorDepnode", depth: "int") -> "void":
        return _pyfreeling.dep_tree_PrintDepTree(n, depth)
...
def dep_tree_PrintDepTree(n: "TreeConstPreorderIteratorDepnode", depth: "int") -> "void":
    return _pyfreeling.dep_tree_PrintDepTree(n, depth)
...
class analyzer_config_options(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    Lang = property(_pyfreeling.analyzer_config_options_Lang_get, _pyfreeling.analyzer_config_options_Lang_set)
    TOK_TokenizerFile = property(_pyfreeling.analyzer_config_options_TOK_TokenizerFile_get, _pyfreeling.analyzer_config_options_TOK_TokenizerFile_set)
    SPLIT_SplitterFile = property(_pyfreeling.analyzer_config_options_SPLIT_SplitterFile_get, _pyfreeling.analyzer_config_options_SPLIT_SplitterFile_set)
    MACO_Decimal = property(_pyfreeling.analyzer_config_options_MACO_Decimal_get, _pyfreeling.analyzer_config_options_MACO_Decimal_set)
    MACO_Thousand = property(_pyfreeling.analyzer_config_options_MACO_Thousand_get, _pyfreeling.analyzer_config_options_MACO_Thousand_set)
    MACO_UserMapFile = property(_pyfreeling.analyzer_config_options_MACO_UserMapFile_get, _pyfreeling.analyzer_config_options_MACO_UserMapFile_set)
    MACO_LocutionsFile = property(_pyfreeling.analyzer_config_options_MACO_LocutionsFile_get, _pyfreeling.analyzer_config_options_MACO_LocutionsFile_set)
    MACO_QuantitiesFile = property(_pyfreeling.analyzer_config_options_MACO_QuantitiesFile_get, _pyfreeling.analyzer_config_options_MACO_QuantitiesFile_set)
    MACO_AffixFile = property(_pyfreeling.analyzer_config_options_MACO_AffixFile_get, _pyfreeling.analyzer_config_options_MACO_AffixFile_set)
    MACO_ProbabilityFile = property(_pyfreeling.analyzer_config_options_MACO_ProbabilityFile_get, _pyfreeling.analyzer_config_options_MACO_ProbabilityFile_set)
    MACO_DictionaryFile = property(_pyfreeling.analyzer_config_options_MACO_DictionaryFile_get, _pyfreeling.analyzer_config_options_MACO_DictionaryFile_set)
    MACO_NPDataFile = property(_pyfreeling.analyzer_config_options_MACO_NPDataFile_get, _pyfreeling.analyzer_config_options_MACO_NPDataFile_set)
    MACO_PunctuationFile = property(_pyfreeling.analyzer_config_options_MACO_PunctuationFile_get, _pyfreeling.analyzer_config_options_MACO_PunctuationFile_set)
    MACO_CompoundFile = property(_pyfreeling.analyzer_config_options_MACO_CompoundFile_get, _pyfreeling.analyzer_config_options_MACO_CompoundFile_set)
    MACO_InverseDictionary = property(_pyfreeling.analyzer_config_options_MACO_InverseDictionary_get, _pyfreeling.analyzer_config_options_MACO_InverseDictionary_set)
    MACO_ProbabilityThreshold = property(_pyfreeling.analyzer_config_options_MACO_ProbabilityThreshold_get, _pyfreeling.analyzer_config_options_MACO_ProbabilityThreshold_set)
    PHON_PhoneticsFile = property(_pyfreeling.analyzer_config_options_PHON_PhoneticsFile_get, _pyfreeling.analyzer_config_options_PHON_PhoneticsFile_set)
    NEC_NECFile = property(_pyfreeling.analyzer_config_options_NEC_NECFile_get, _pyfreeling.analyzer_config_options_NEC_NECFile_set)
    SENSE_ConfigFile = property(_pyfreeling.analyzer_config_options_SENSE_ConfigFile_get, _pyfreeling.analyzer_config_options_SENSE_ConfigFile_set)
    UKB_ConfigFile = property(_pyfreeling.analyzer_config_options_UKB_ConfigFile_get, _pyfreeling.analyzer_config_options_UKB_ConfigFile_set)
    TAGGER_HMMFile = property(_pyfreeling.analyzer_config_options_TAGGER_HMMFile_get, _pyfreeling.analyzer_config_options_TAGGER_HMMFile_set)
    TAGGER_RelaxFile = property(_pyfreeling.analyzer_config_options_TAGGER_RelaxFile_get, _pyfreeling.analyzer_config_options_TAGGER_RelaxFile_set)
    TAGGER_RelaxMaxIter = property(_pyfreeling.analyzer_config_options_TAGGER_RelaxMaxIter_get, _pyfreeling.analyzer_config_options_TAGGER_RelaxMaxIter_set)
    TAGGER_RelaxScaleFactor = property(_pyfreeling.analyzer_config_options_TAGGER_RelaxScaleFactor_get, _pyfreeling.analyzer_config_options_TAGGER_RelaxScaleFactor_set)
    TAGGER_RelaxEpsilon = property(_pyfreeling.analyzer_config_options_TAGGER_RelaxEpsilon_get, _pyfreeling.analyzer_config_options_TAGGER_RelaxEpsilon_set)
    PARSER_GrammarFile = property(_pyfreeling.analyzer_config_options_PARSER_GrammarFile_get, _pyfreeling.analyzer_config_options_PARSER_GrammarFile_set)
    DEP_TxalaFile = property(_pyfreeling.analyzer_config_options_DEP_TxalaFile_get, _pyfreeling.analyzer_config_options_DEP_TxalaFile_set)
    DEP_TreelerFile = property(_pyfreeling.analyzer_config_options_DEP_TreelerFile_get, _pyfreeling.analyzer_config_options_DEP_TreelerFile_set)
    DEP_LSTMFile = property(_pyfreeling.analyzer_config_options_DEP_LSTMFile_get, _pyfreeling.analyzer_config_options_DEP_LSTMFile_set)
    SRL_TreelerFile = property(_pyfreeling.analyzer_config_options_SRL_TreelerFile_get, _pyfreeling.analyzer_config_options_SRL_TreelerFile_set)
    COREF_CorefFile = property(_pyfreeling.analyzer_config_options_COREF_CorefFile_get, _pyfreeling.analyzer_config_options_COREF_CorefFile_set)
    SEMGRAPH_SemGraphFile = property(_pyfreeling.analyzer_config_options_SEMGRAPH_SemGraphFile_get, _pyfreeling.analyzer_config_options_SEMGRAPH_SemGraphFile_set)

    def __init__(self):
        _pyfreeling.analyzer_config_options_swiginit(self, _pyfreeling.new_analyzer_config_options())
    __swig_destroy__ = _pyfreeling.delete_analyzer_config_options

# Register analyzer_config_options in _pyfreeling:
_pyfreeling.analyzer_config_options_swigregister(analyzer_config_options)

class analyzer_invoke_options(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    InputLevel = property(_pyfreeling.analyzer_invoke_options_InputLevel_get, _pyfreeling.analyzer_invoke_options_InputLevel_set)
    OutputLevel = property(_pyfreeling.analyzer_invoke_options_OutputLevel_get, _pyfreeling.analyzer_invoke_options_OutputLevel_set)
    MACO_UserMap = property(_pyfreeling.analyzer_invoke_options_MACO_UserMap_get, _pyfreeling.analyzer_invoke_options_MACO_UserMap_set)
    MACO_AffixAnalysis = property(_pyfreeling.analyzer_invoke_options_MACO_AffixAnalysis_get, _pyfreeling.analyzer_invoke_options_MACO_AffixAnalysis_set)
    MACO_MultiwordsDetection = property(_pyfreeling.analyzer_invoke_options_MACO_MultiwordsDetection_get, _pyfreeling.analyzer_invoke_options_MACO_MultiwordsDetection_set)
    MACO_NumbersDetection = property(_pyfreeling.analyzer_invoke_options_MACO_NumbersDetection_get, _pyfreeling.analyzer_invoke_options_MACO_NumbersDetection_set)
    MACO_PunctuationDetection = property(_pyfreeling.analyzer_invoke_options_MACO_PunctuationDetection_get, _pyfreeling.analyzer_invoke_options_MACO_PunctuationDetection_set)
    MACO_DatesDetection = property(_pyfreeling.analyzer_invoke_options_MACO_DatesDetection_get, _pyfreeling.analyzer_invoke_options_MACO_DatesDetection_set)
    MACO_QuantitiesDetection = property(_pyfreeling.analyzer_invoke_options_MACO_QuantitiesDetection_get, _pyfreeling.analyzer_invoke_options_MACO_QuantitiesDetection_set)
    MACO_DictionarySearch = property(_pyfreeling.analyzer_invoke_options_MACO_DictionarySearch_get, _pyfreeling.analyzer_invoke_options_MACO_DictionarySearch_set)
    MACO_ProbabilityAssignment = property(_pyfreeling.analyzer_invoke_options_MACO_ProbabilityAssignment_get, _pyfreeling.analyzer_invoke_options_MACO_ProbabilityAssignment_set)
    MACO_CompoundAnalysis = property(_pyfreeling.analyzer_invoke_options_MACO_CompoundAnalysis_get, _pyfreeling.analyzer_invoke_options_MACO_CompoundAnalysis_set)
    MACO_NERecognition = property(_pyfreeling.analyzer_invoke_options_MACO_NERecognition_get, _pyfreeling.analyzer_invoke_options_MACO_NERecognition_set)
    MACO_RetokContractions = property(_pyfreeling.analyzer_invoke_options_MACO_RetokContractions_get, _pyfreeling.analyzer_invoke_options_MACO_RetokContractions_set)
    PHON_Phonetics = property(_pyfreeling.analyzer_invoke_options_PHON_Phonetics_get, _pyfreeling.analyzer_invoke_options_PHON_Phonetics_set)
    NEC_NEClassification = property(_pyfreeling.analyzer_invoke_options_NEC_NEClassification_get, _pyfreeling.analyzer_invoke_options_NEC_NEClassification_set)
    TAGGER_Retokenize = property(_pyfreeling.analyzer_invoke_options_TAGGER_Retokenize_get, _pyfreeling.analyzer_invoke_options_TAGGER_Retokenize_set)
    TAGGER_ForceSelect = property(_pyfreeling.analyzer_invoke_options_TAGGER_ForceSelect_get, _pyfreeling.analyzer_invoke_options_TAGGER_ForceSelect_set)
    TAGGER_kbest = property(_pyfreeling.analyzer_invoke_options_TAGGER_kbest_get, _pyfreeling.analyzer_invoke_options_TAGGER_kbest_set)
    SENSE_WSD_which = property(_pyfreeling.analyzer_invoke_options_SENSE_WSD_which_get, _pyfreeling.analyzer_invoke_options_SENSE_WSD_which_set)
    TAGGER_which = property(_pyfreeling.analyzer_invoke_options_TAGGER_which_get, _pyfreeling.analyzer_invoke_options_TAGGER_which_set)
    DEP_which = property(_pyfreeling.analyzer_invoke_options_DEP_which_get, _pyfreeling.analyzer_invoke_options_DEP_which_set)
    SRL_which = property(_pyfreeling.analyzer_invoke_options_SRL_which_get, _pyfreeling.analyzer_invoke_options_SRL_which_set)

    def __init__(self):
        _pyfreeling.analyzer_invoke_options_swiginit(self, _pyfreeling.new_analyzer_invoke_options())
    __swig_destroy__ = _pyfreeling.delete_analyzer_invoke_options

# Register analyzer_invoke_options in _pyfreeling:
_pyfreeling.analyzer_invoke_options_swigregister(analyzer_invoke_options)
...
class analyzer_config(object):
    ...
    def command_line_options(self) -> "po::options_description &":
        return _pyfreeling.analyzer_config_command_line_options(self)

    def config_file_options(self) -> "po::options_description &":
        return _pyfreeling.analyzer_config_config_file_options(self)

    def parse_options(self, *args) -> "void":
        return _pyfreeling.analyzer_config_parse_options(self, *args)

    def check_invoke_options(self, opt: "analyzer_invoke_options") -> "freeling::status":
...
class analyzer(object):
    ...
    def __init__(self, *args):
        _pyfreeling.analyzer_swiginit(self, _pyfreeling.new_analyzer(*args))
    __swig_destroy__ = _pyfreeling.delete_analyzer

    def analyze_as_document(self, *args) -> "freeling::document":
        return _pyfreeling.analyzer_analyze_as_document(self, *args)
    ...
    def flush_buffer(self, *args) -> "void":
        return _pyfreeling.analyzer_flush_buffer(self, *args)
...
class traces(object):
    ...
    def set_trace_level(self, l: "int") -> "void":
        return _pyfreeling.traces_set_trace_level(self, l)

    def set_trace_module(self, m: "unsigned long long") -> "void":
        return _pyfreeling.traces_set_trace_module(self, m)
...
class tokenizer(object):
    ...
    def tokenize(self, *args) -> "std::list< freeling::word,std::allocator< freeling::word > >":
...
class processor(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _pyfreeling.delete_processor

    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.processor_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.processor_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.processor_analyze_document(self, d)

# Register processor in _pyfreeling:
_pyfreeling.processor_swigregister(processor)

class maco(processor):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, arg2: "analyzer_config"):
        _pyfreeling.maco_swiginit(self, _pyfreeling.new_maco(arg2))
    __swig_destroy__ = _pyfreeling.delete_maco

    def get_initial_options(self) -> "freeling::analyzer_config const &":
        return _pyfreeling.maco_get_initial_options(self)

    def set_current_invoke_options(self, opt: "analyzer_invoke_options") -> "void":
        return _pyfreeling.maco_set_current_invoke_options(self, opt)

    def get_current_invoke_options(self) -> "freeling::analyzer_invoke_options const &":
        return _pyfreeling.maco_get_current_invoke_options(self)
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.maco_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.maco_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.maco_analyze_document(self, d)

# Register maco in _pyfreeling:
_pyfreeling.maco_swigregister(maco)

class RE_map(processor):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.RE_map_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.RE_map_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.RE_map_analyze_document(self, d)
...
class numbers(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.numbers_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.numbers_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.numbers_analyze_document(self, d)

# Register numbers in _pyfreeling:
_pyfreeling.numbers_swigregister(numbers)

class punts(processor):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.punts_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.punts_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.punts_analyze_document(self, d)
...
class dates(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.dates_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.dates_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.dates_analyze_document(self, d)
...
class dictionary(processor):
    ...
    def __init__(self, opts: "analyzer_config"):
        _pyfreeling.dictionary_swiginit(self, _pyfreeling.new_dictionary(opts))
    __swig_destroy__ = _pyfreeling.delete_dictionary

    def get_initial_options(self) -> "freeling::analyzer_config const &":
        return _pyfreeling.dictionary_get_initial_options(self)

    def set_current_invoke_options(self, opt: "analyzer_invoke_options") -> "void":
        return _pyfreeling.dictionary_set_current_invoke_options(self, opt)

    def get_current_invoke_options(self) -> "freeling::analyzer_invoke_options const &":
        return _pyfreeling.dictionary_get_current_invoke_options(self)
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.dictionary_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.dictionary_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.dictionary_analyze_document(self, d)
...
class locutions(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.locutions_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.locutions_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.locutions_analyze_document(self, d)
...
class ner(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.ner_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.ner_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.ner_analyze_document(self, d)
...
class crf_nerc(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.crf_nerc_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.crf_nerc_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.crf_nerc_analyze_document(self, d)
...
class quantities(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.quantities_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.quantities_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.quantities_analyze_document(self, d)

# Register quantities in _pyfreeling:
_pyfreeling.quantities_swigregister(quantities)

class probabilities(processor):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.probabilities_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.probabilities_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.probabilities_analyze_document(self, d)
...
class hmm_tagger(object):
    ...
    def __init__(self, opt: "analyzer_config"):
        _pyfreeling.hmm_tagger_swiginit(self, _pyfreeling.new_hmm_tagger(opt))
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.hmm_tagger_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.hmm_tagger_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.hmm_tagger_analyze_document(self, d)
...
class relax_tagger(object):
    ...
    def __init__(self, opt: "analyzer_config"):
        _pyfreeling.relax_tagger_swiginit(self, _pyfreeling.new_relax_tagger(opt))
    __swig_destroy__ = _pyfreeling.delete_relax_tagger

    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.relax_tagger_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.relax_tagger_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.relax_tagger_analyze_document(self, d)

# Register relax_tagger in _pyfreeling:
_pyfreeling.relax_tagger_swigregister(relax_tagger)

class alternatives(processor):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.alternatives_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.alternatives_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.alternatives_analyze_document(self, d)

# Register alternatives in _pyfreeling:
_pyfreeling.alternatives_swigregister(alternatives)

class phonetics(processor):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.phonetics_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.phonetics_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.phonetics_analyze_document(self, d)
...
class nec(processor):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.nec_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.nec_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.nec_analyze_document(self, d)

# Register nec in _pyfreeling:
_pyfreeling.nec_swigregister(nec)

class chart_parser(processor):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.chart_parser_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.chart_parser_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.chart_parser_analyze_document(self, d)
...
class dep_txala(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.dep_txala_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.dep_txala_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.dep_txala_analyze_document(self, d)
...
class dep_treeler(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.dep_treeler_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.dep_treeler_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.dep_treeler_analyze_document(self, d)
...
class dep_lstm(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.dep_lstm_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.dep_lstm_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.dep_lstm_analyze_document(self, d)
...
class srl_treeler(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.srl_treeler_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.srl_treeler_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.srl_treeler_analyze_document(self, d)

# Register srl_treeler in _pyfreeling:
_pyfreeling.srl_treeler_swigregister(srl_treeler)

class senses(processor):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.senses_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.senses_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.senses_analyze_document(self, d)
...
class ukb(object):
    ...
    def analyze_sentence(self, s: "sentence") -> "freeling::sentence":
        return _pyfreeling.ukb_analyze_sentence(self, s)

    def analyze_sentence_list(self, arg2: "ListSentence") -> "std::list< freeling::sentence,std::allocator< freeling::sentence > >":
        return _pyfreeling.ukb_analyze_sentence_list(self, arg2)

    def analyze_document(self, d: "document") -> "freeling::document":
        return _pyfreeling.ukb_analyze_document(self, d)
